...
export default function HeroAppPreview() {
  return (
    <div
      className="relative mx-auto w-full max-w-2xl px-8 sm:px-0 lg:max-w-none"
      aria-hidden
    >
      ...
      <div className="relative mx-auto aspect-[4/2.9] w-full max-w-[16.5rem] translate-y-[86px] sm:max-w-none sm:translate-y-[90px] sm:aspect-[5/3.5] lg:aspect-[16/10] lg:translate-y-[94px]">
        ...
        {/* 모바일 — 2초 후 등장 */}
        <div className="mkt-hero-mobile absolute bottom-0 left-0 z-10 w-[36%] max-w-[8.25rem] sm:w-[44%] sm:max-w-[12.5rem] lg:max-w-[13.5rem]">
