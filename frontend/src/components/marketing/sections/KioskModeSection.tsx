...
export default function KioskModeSection({ title, paragraphs, youtube }: KioskModeContent) {
    ...
    <MarketingSection variant="primary-tint">
      <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-12 xl:gap-16">
        <div className="max-w-xl">
          <h2 className="mkt-h2 text-2xl sm:text-3xl lg:text-[2rem] lg:leading-tight">{title}</h2>
