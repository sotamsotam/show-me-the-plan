  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-gray-50 p-4 text-sm text-gray-700 dark:border-neutral-700 dark:bg-zinc-900/50 dark:text-gray-300">
      ...
      <ul className="mt-3 list-disc space-y-2 pl-5">
        <li>
          신규 가입 학생은 <strong>14일 무료 체험</strong> 동안 카드 등록 없이 전 기능을 이용할
          수 있습니다.
        </li>
        <li>
          <strong>카드 등록 및 결제 완료 시</strong> 화면에 표시된 금액(
          <strong>월 4,900원, VAT 포함</strong>)이 <strong>즉시 결제</strong>되며, 이후{' '}
          <strong>매월 자동 갱신</strong>됩니다.
        </li>
        <li>
          해지는 <strong>설정 → 구독 · 결제</strong>에서 &quot;해지 예약&quot;으로 가능하며,{' '}
          <strong>이용 기간 종료 전</strong>까지 &quot;해지 예약 취소&quot;로 철회할 수
          있습니다.
        </li>
        <li>
          체험 종료 후 구독하지 않으면 대시보드 이용이 제한됩니다. 구독·결제 관련 화면은 계속
          이용할 수 있습니다.
        </li>
        <li>
          만 14세 미만 학생은 법정대리인 동의가 필요합니다. 가입 시 확인한 동의 정보가 없으면
          결제할 수 없습니다.
        </li>
        <li>
          환불·청약철회 기준은{' '}
