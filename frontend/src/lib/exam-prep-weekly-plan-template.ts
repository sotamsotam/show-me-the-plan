...
export interface ExamPrepWeeklyPlanTemplatesResponse {
  examPrepWeeklyPlanTemplates: ExamPrepWeeklyPlanTemplate[];
}

export interface ExamPrepWeeklyPlanTemplateSaveResponse {
  examPrepWeeklyPlanTemplates: ExamPrepWeeklyPlanTemplate[];
  template: ExamPrepWeeklyPlanTemplate;
}
