...
export interface ExamPeriodSettingsResponse {
  examPeriodSettings: ExamPeriodSettings;
  neisExamSuggestions: NeisExamSuggestions;
}

export interface ExamPeriodSettingsSaveResponse {
  examPeriodSettings: ExamPeriodSettings;
}
...
export function rangeToDateInputs(range: ExamPeriodRange | null): {
  start: string;
  end: string;
} {
  if (!range) {
