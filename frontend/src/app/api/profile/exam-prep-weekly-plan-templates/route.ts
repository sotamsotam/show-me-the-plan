...
export async function GET(request: NextRequest) {
  ...
  const res = await strapiFetch(
    `/api/user-profiles/exam-prep-weekly-plan-templates?${params}`,
    { jwt }
  );
...
export async function POST(request: NextRequest) {
  ...
  const res = await strapiFetch('/api/user-profiles/exam-prep-weekly-plan-templates', {
    method: 'POST',
    jwt,
