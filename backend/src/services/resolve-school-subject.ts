import type { LegacyStudyPlanSubject } from './user-subject';

interface SubjectRule {
  key: LegacyStudyPlanSubject;
  patterns: RegExp[];
}
...
const SUBJECT_RULES: SubjectRule[] = [
  ...
  {
    key: 'social',
    patterns: [/사회/, /통합사회/, /일반사회/, /정치/, /경제/, /법과\s*정치/],
  },
...
export function resolveSchoolSubject(subjectName: string): LegacyStudyPlanSubject {
