...
export interface ApiStudentManagerAssignmentStudentManagerAssignment
  ...
  info: {
    description: 'Student-to-manager assignment records for multi-manager support';
    displayName: 'Student Manager Assignment';
    pluralName: 'student-manager-assignments';
    singularName: 'student-manager-assignment';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::student-manager-assignment.student-manager-assignment'
    > &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['active', 'removed']> &
      Schema.Attribute.Required &
...
export interface ApiStudyPlanTodoStudyPlanTodo
  extends Struct.CollectionTypeSchema {
  collectionName: 'study_plan_todos';
  info: {
    description: 'User study plan todos (weekly recurring or one-time)';
    displayName: 'Study Plan Todo';
    pluralName: 'study-plan-todos';
    singularName: 'study-plan-todo';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    executionRecords: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiUserProfileUserProfile extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User school information for timetable integration';
  ...
  attributes: {
    atptOfcdcScCode: Schema.Attribute.String;
    className: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    examPeriodSettings: Schema.Attribute.JSON;
    examPrepWeeklyPlans: Schema.Attribute.JSON;
    examPrepWeeklyPlanTemplates: Schema.Attribute.JSON;
    examPrepWeeksBefore: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 12;
          min: 1;
    ...
    publishedAt: Schema.Attribute.DateTime;
    regularWeeklyPlans: Schema.Attribute.JSON;
    regularWeeklyPlanTemplates: Schema.Attribute.JSON;
    schoolLevel: Schema.Attribute.Enumeration<
      ['elementary', 'middle', 'high', 'other', 'manager']
    > &
      Schema.Attribute.Required;
    schoolName: Schema.Attribute.String;
    sdSchulCode: Schema.Attribute.String;
    subjects: Schema.Attribute.JSON;
    termsAgreedAt: Schema.Attribute.DateTime;
...
export interface ApiUserScheduleUserSchedule
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_schedules';
  info: {
    description: 'User-created schedules (weekly recurring or one-time)';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-schedule.user-schedule'
    > &
      Schema.Attribute.Private;
    overrides: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
