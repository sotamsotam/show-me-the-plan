...
**1차 확정:** **포트원 V2** (2026-06-22 전환 — [`BILLING-PORTONE-MIGRATION-TODO.md`](./BILLING-PORTONE-MIGRATION-TODO.md))  
_초기 구현은 토스페이먼츠 기준이었으나, 실연동 전 포트원으로 변경됨._
